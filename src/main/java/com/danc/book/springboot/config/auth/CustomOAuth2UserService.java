...
import com.danc.book.springboot.config.auth.dto.OAuthAttributes;
import com.danc.book.springboot.config.auth.dto.SessionUser;
import com.danc.book.springboot.domain.user.User;
import com.danc.book.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        OAuth2UserService<OAuth2UserRequest, OAuth2User> delgate
